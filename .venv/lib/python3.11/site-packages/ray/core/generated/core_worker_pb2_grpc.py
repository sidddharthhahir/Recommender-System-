...
class CoreWorkerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.FreeActorObject = channel.unary_unary(
                '/ray.rpc.CoreWorkerService/FreeActorObject',
                request_serializer=src_dot_ray_dot_protobuf_dot_core__worker__pb2.FreeActorObjectRequest.SerializeToString,
                response_deserializer=src_dot_ray_dot_protobuf_dot_core__worker__pb2.FreeActorObjectReply.FromString,
                )
...
class CoreWorkerServiceServicer(object):
    ...
    def FreeActorObject(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_CoreWorkerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'FreeActorObject': grpc.unary_unary_rpc_method_handler(
                    servicer.FreeActorObject,
                    request_deserializer=src_dot_ray_dot_protobuf_dot_core__worker__pb2.FreeActorObjectRequest.FromString,
                    response_serializer=src_dot_ray_dot_protobuf_dot_core__worker__pb2.FreeActorObjectReply.SerializeToString,
            ),
...
class CoreWorkerService(object):
    ...
    def FreeActorObject(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ray.rpc.CoreWorkerService/FreeActorObject',
            src_dot_ray_dot_protobuf_dot_core__worker__pb2.FreeActorObjectRequest.SerializeToString,
            src_dot_ray_dot_protobuf_dot_core__worker__pb2.FreeActorObjectReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
