...
LOGIN_REDIRECT_URL = 'recommender:recommendations'   # default landing page
LOGOUT_REDIRECT_URL = 'accounts:login'               # where to go after logout

# Optional: where the login form is
...
# Custom settings
LIGHTFM_MODEL_PATH = BASE_DIR / 'models' / 'lightfm_model.pkl'
EXPLANATION_CACHE_TIMEOUT = 3600  # 1 hour